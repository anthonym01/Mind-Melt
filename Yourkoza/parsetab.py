...
_lr_productions = [
  ...
  ('program -> statements','program',1,'p_program','Lexyacc_er.py',205),
  ('program -> expression','program',1,'p_program','Lexyacc_er.py',206),
  ('statements -> statements statement','statements',2,'p_statements','Lexyacc_er.py',210),
  ('statements -> statement','statements',1,'p_statements','Lexyacc_er.py',211),
  ('statement -> assignment','statement',1,'p_statement','Lexyacc_er.py',219),
  ('statement -> conditional','statement',1,'p_statement','Lexyacc_er.py',220),
  ('statement -> loop','statement',1,'p_statement','Lexyacc_er.py',221),
  ('statement -> function','statement',1,'p_statement','Lexyacc_er.py',222),
  ('statement -> display','statement',1,'p_statement','Lexyacc_er.py',223),
  ('statement -> input','statement',1,'p_statement','Lexyacc_er.py',224),
  ('statement -> COMMENT','statement',1,'p_statement','Lexyacc_er.py',225),
  ('assignment -> LET IDENTIFIER BE EQUAL TO expression','assignment',6,'p_assignment','Lexyacc_er.py',230),
  ('conditional -> IF condition THEN statements else_statements_opt','conditional',5,'p_conditional','Lexyacc_er.py',235),
  ('else_statements_opt -> ELSE statements','else_statements_opt',2,'p_else_statements_opt','Lexyacc_er.py',239),
  ('else_statements_opt -> empty','else_statements_opt',1,'p_else_statements_opt','Lexyacc_er.py',240),
  ('condition -> expression IS_LESS_THAN expression','condition',3,'p_condition','Lexyacc_er.py',246),
  ('condition -> expression IS_EQUAL_TO expression','condition',3,'p_condition','Lexyacc_er.py',247),
  ('condition -> expression IS_GREATER_THAN expression','condition',3,'p_condition','Lexyacc_er.py',248),
  ('condition -> expression IS_NOT_EQUAL_TO expression','condition',3,'p_condition','Lexyacc_er.py',249),
  ('expression -> expression PLUS term','expression',3,'p_expression','Lexyacc_er.py',253),
  ('expression -> expression MINUS term','expression',3,'p_expression','Lexyacc_er.py',254),
  ('expression -> term','expression',1,'p_expression','Lexyacc_er.py',255),
  ('term -> term TIMES factor','term',3,'p_term','Lexyacc_er.py',265),
  ('term -> term DIVIDE factor','term',3,'p_term','Lexyacc_er.py',266),
  ('term -> factor','term',1,'p_term','Lexyacc_er.py',267),
  ('factor -> NUMBER','factor',1,'p_factor','Lexyacc_er.py',277),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','Lexyacc_er.py',278),
  ('input -> LET IDENTIFIER BE EQUAL TO SHOW IDENTIFIER LPAREN STRING_LITERAL RPAREN','input',10,'p_input','Lexyacc_er.py',285),
  ('display -> SHOW expression','display',2,'p_display','Lexyacc_er.py',289),
  ('loop -> FOR IDENTIFIER IN list DO statements','loop',6,'p_loop','Lexyacc_er.py',293),
  ('loop -> WHILE condition DO statements','loop',4,'p_loop','Lexyacc_er.py',294),
  ('list -> LBRACKET expression_list RBRACKET','list',3,'p_list','Lexyacc_er.py',299),
  ('list -> empty','list',1,'p_list','Lexyacc_er.py',300),
  ('expression_list -> expression','expression_list',1,'p_expression_list','Lexyacc_er.py',306),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list','Lexyacc_er.py',307),
  ('function -> FUNCTION IDENTIFIER LPAREN parameters RPAREN LBRACE statements RBRACE return_statement_opt RBRACE','function',10,'p_function','Lexyacc_er.py',314),
  ('parameters -> IDENTIFIER','parameters',1,'p_parameters','Lexyacc_er.py',318),
  ('parameters -> parameters COMMA IDENTIFIER','parameters',3,'p_parameters','Lexyacc_er.py',319),
  ('return_statement_opt -> RETURN expression','return_statement_opt',2,'p_return_statement_opt','Lexyacc_er.py',326),
  ('return_statement_opt -> empty','return_statement_opt',1,'p_return_statement_opt','Lexyacc_er.py',327),
  ('empty -> <empty>','empty',0,'p_empty','Lexyacc_er.py',333),
]
