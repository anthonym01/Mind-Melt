...
_lr_productions = [
  ...
  ('program -> statements','program',1,'p_program','Lexyacc_er.py',50),
  ('program -> expression','program',1,'p_program','Lexyacc_er.py',51),
  ('statements -> statements statement','statements',2,'p_statements','Lexyacc_er.py',55),
  ('statements -> statement','statements',1,'p_statements','Lexyacc_er.py',56),
  ('statement -> assignment','statement',1,'p_statement','Lexyacc_er.py',64),
  ('statement -> conditional','statement',1,'p_statement','Lexyacc_er.py',65),
  ('statement -> loop','statement',1,'p_statement','Lexyacc_er.py',66),
  ('statement -> function','statement',1,'p_statement','Lexyacc_er.py',67),
  ('statement -> display','statement',1,'p_statement','Lexyacc_er.py',68),
  ('statement -> input','statement',1,'p_statement','Lexyacc_er.py',69),
  ('statement -> COMMENT','statement',1,'p_statement','Lexyacc_er.py',70),
  ('assignment -> LET IDENTIFIER BE EQUAL TO expression','assignment',6,'p_assignment','Lexyacc_er.py',75),
  ('conditional -> IF condition THEN statements else_statements_opt','conditional',5,'p_conditional','Lexyacc_er.py',80),
  ('else_statements_opt -> ELSE statements','else_statements_opt',2,'p_else_statements_opt','Lexyacc_er.py',84),
  ('else_statements_opt -> empty','else_statements_opt',1,'p_else_statements_opt','Lexyacc_er.py',85),
  ('condition -> expression IS_LESS_THAN expression','condition',3,'p_condition','Lexyacc_er.py',91),
  ('condition -> expression IS_EQUAL_TO expression','condition',3,'p_condition','Lexyacc_er.py',92),
  ('condition -> expression IS_GREATER_THAN expression','condition',3,'p_condition','Lexyacc_er.py',93),
  ('condition -> expression IS_NOT_EQUAL_TO expression','condition',3,'p_condition','Lexyacc_er.py',94),
  ('expression -> expression PLUS term','expression',3,'p_expression','Lexyacc_er.py',98),
  ('expression -> expression MINUS term','expression',3,'p_expression','Lexyacc_er.py',99),
  ('expression -> term','expression',1,'p_expression','Lexyacc_er.py',100),
  ('term -> term TIMES factor','term',3,'p_term','Lexyacc_er.py',110),
  ('term -> term DIVIDE factor','term',3,'p_term','Lexyacc_er.py',111),
  ('term -> factor','term',1,'p_term','Lexyacc_er.py',112),
  ('factor -> NUMBER','factor',1,'p_factor','Lexyacc_er.py',122),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','Lexyacc_er.py',123),
  ('input -> LET IDENTIFIER BE EQUAL TO SHOW IDENTIFIER LPAREN STRING_LITERAL RPAREN','input',10,'p_input','Lexyacc_er.py',130),
  ('display -> SHOW expression','display',2,'p_display','Lexyacc_er.py',134),
  ('loop -> FOR IDENTIFIER IN list DO statements','loop',6,'p_loop','Lexyacc_er.py',138),
  ('loop -> WHILE condition DO statements','loop',4,'p_loop','Lexyacc_er.py',139),
  ('list -> LBRACKET expression_list RBRACKET','list',3,'p_list','Lexyacc_er.py',144),
  ('list -> empty','list',1,'p_list','Lexyacc_er.py',145),
  ('expression_list -> expression','expression_list',1,'p_expression_list','Lexyacc_er.py',151),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list','Lexyacc_er.py',152),
  ('function -> FUNCTION IDENTIFIER LPAREN parameters RPAREN LBRACE statements RBRACE return_statement_opt RBRACE','function',10,'p_function','Lexyacc_er.py',159),
  ('parameters -> IDENTIFIER','parameters',1,'p_parameters','Lexyacc_er.py',163),
  ('parameters -> parameters COMMA IDENTIFIER','parameters',3,'p_parameters','Lexyacc_er.py',164),
  ('return_statement_opt -> RETURN expression','return_statement_opt',2,'p_return_statement_opt','Lexyacc_er.py',171),
  ('return_statement_opt -> empty','return_statement_opt',1,'p_return_statement_opt','Lexyacc_er.py',172),
  ('empty -> <empty>','empty',0,'p_empty','Lexyacc_er.py',178),
]
