...
#     """
#     if len(p) == 4:
#         _, expr1, sign, expr2 = p
#         p[0] = ('expression', expr1, sign, expr2)
...
def p_function_call(p):
    ...
    p[0] = ('function_call', {'name': p[1], 'arguments': p[3]})

def p_function(p):
    '''function : FUNCTION IDENTIFIER LPAREN parameters RPAREN LBRACE statements return_statement_opt RBRACE'''
